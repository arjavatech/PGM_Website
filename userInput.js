...
// function user2(){
//     let userName = document.querySelector(".user2")
//     let userLogo = document.querySelector(".userIcon2")
//     let user_star = document.querySelector(".user_star2")
//     let user_comment = document.querySelector(".user_para2")
...
// function user3(){
//     let userName = document.querySelector(".user3")
//     let userLogo = document.querySelector(".userIcon3")
//     let user_star = document.querySelector(".user_star3")
//     let user_comment = document.querySelector(".user_para3")
...
function user4(){
    let userName = document.querySelector(".user4")
    let userLogo = document.querySelector(".userIcon4")
    let user_star = document.querySelector(".user_star4")
    let user_comment = document.querySelector(".user_para4")
